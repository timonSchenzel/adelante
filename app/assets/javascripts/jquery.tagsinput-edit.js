    ...
    var settings = jQuery.extend({
      ...
      inputPadding: 6*2
		...
		this.each(function() {
			...
			var markup = '<div id="'+id+'_tagsinput" class="input-xlarge uneditable-input tagsinput"><div id="'+id+'_addTag">';

			if (settings.interactive) {
				markup = markup + '<input id="'+id+'_tag" value="" data-default="'+settings.defaultText+'" style="width: 700px !important;" />';
			}
